...
export function Hero() {
  ...
  useEffect(() => {
    ...
    const animate = () => {
      ...
      ctx.stroke();
      // Solo reprograma el siguiente frame mientras el bucle esté activo.
      if (running) {
    ...
    // Inicializa la malla
    initGrid();
    // Anima solo cuando el Hero está en pantalla y la pestaña está visible.
    let isOnScreen = true;
    const reconcile = () => {
      ...
      <div className="container mx-auto px-6 relative z-10 grid grid-cols-1 lg:grid-cols-12 gap-8 xl:gap-12 items-center min-h-screen pt-32 lg:pt-40 xl:pt-20 2xl:pt-40 pb-20 pointer-events-none">
        ...
        >
          ...
          <p className="text-xl md:text-2xl text-foreground font-open-sans max-w-xl font-normal">
            Desarrollamos software, inteligencia artificial y automatizaciones
        ...
        >
          {/* Widget IA */}
          <m.div
            className="absolute top-[5%] md:top-[8%] left-[0%] lg:left-[5%] xl:left-[2%] xl:top-[10%] 2xl:top-[5%] 2xl:left-[3%] w-[340px] md:w-[380px] 2xl:w-[440px] glass-card bg-foreground/5 backdrop-blur-[2px] p-6 2xl:p-8 rounded-[2rem] z-30 shadow-primary border border-foreground/10 overflow-hidden"
            style={{ y: y2 }}
          >
            ...
            <div className="flex items-center gap-4 mb-8 pb-4 border-b border-foreground/10">
              ...
              <div>
                <h3 className="font-kanit font-bold text-foreground text-lg leading-tight">
                  Inteligencia Artificial
                </h3>
                <p className="text-[10px] text-foreground/50 font-mono tracking-widest uppercase mt-0.5">
                  Especializada en tu negocio
                </p>
              </div>
            </div>
            {/* Chat */}
                        ...
                        {chatStep === 1 ? (
                          ...
                          <div className="space-y-3">
                            ...
                            >
                              ...
                              <span className="font-kanit font-bold tracking-wide">
                                {activeScenario.highlight}
                              </span>
                              <CheckCircle2
                                size={16}
            ...
            <div className="flex items-center gap-4 mb-6 pb-4 border-b border-foreground/10">
              <div className="relative flex items-center justify-center w-12 h-12 rounded-2xl bg-primary/10 text-primary shadow-inner overflow-hidden border border-primary/20">
                <Cog
                  size={24}
                  className={
                    autoStep === 1 ? "animate-[spin_1.5s_linear_infinite]" : ""
                  }
                />
              </div>
              <div>
              ...
              <AnimatePresence mode="wait">
                ...
                >
                  <div className="flex items-center gap-3 mb-4">
                    ...
                    <span className="font-kanit font-semibold text-sm text-foreground/90">
                      {activeAutoScenario.title}
                    </span>
                  </div>
                  ...
                  <div className="bg-secondary/80 backdrop-blur-md rounded-xl p-4 border border-foreground/10 shadow-inner">
                    <div className="flex justify-between items-center mb-3">
                      ...
                      {autoStep === 1 && (
                        <span className="text-[10px] uppercase font-bold text-green-600 animate-pulse tracking-wider">
                          Ejecutando
                        </span>
                      )}
                      {autoStep === 2 && (
                    ...
                    <div className="flex items-center justify-between">
                      <div className="flex items-center gap-2">
                        {autoStep === 2 ? (
                          ...
                          <Play size={16} className="text-foreground/40" />
                        )}
                        <span
                          className={`text-xs font-bold ${autoStep === 2 ? "text-green-600" : "text-foreground/40"}`}
                        >
                          {autoStep === 2
                            ? activeAutoScenario.saved
                            : "Tarea iniciada"}
                        </span>
                      </div>
                      <div
                        className={`px-2 py-0.5 rounded text-[10px] font-bold ${autoStep === 2 ? "bg-green-600/20 text-green-600" : "bg-foreground/10 text-foreground/50"}`}
                      >
                        {autoStep === 2 ? "100%" : "0%"}
                      </div>
                    </div>
